...
path = '../../RPBE_PreProduction/RDF_AIMD_KOH_ML/'
...
for i in range(len(folder)):
    Traj = hop.Prot_Hop(path+folder[i], n_steps)
    ...
    press[i] = Traj.pressure(plotting=True, move_ave=500)
    e_tot = Traj.tot_energy(plotting=True, move_ave=500)
    e_pot = Traj.pot_energy(plotting=True, move_ave=500)
    e_kin = Traj.kin_energy(plotting=True, move_ave=500)
    Temp[i] = Traj.temperature(plotting=True, move_ave=500)
...
>>>>>>> 8525990645302c8816ccd52973360b3387ad3420
